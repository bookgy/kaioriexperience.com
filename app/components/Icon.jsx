const icons = {
  ...
  barChart: '<path d="M3 3v18h18"/><path d="M8 17V9"/><path d="M13 17V5"/><path d="M18 17v-4"/>',
  ...
  fileCheck: '<path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5z"/><path d="M14 2v6h6"/><path d="m9 15 2 2 4-4"/>',
  ...
  utensils: '<path d="M3 2v7c0 1.1.9 2 2 2h1v11"/><path d="M7 2v20"/><path d="M21 15V2a5 5 0 0 0-5 5v6c0 1.1.9 2 2 2z"/><path d="M18 15v7"/>',
...
export default function Icon({ name = "target", className = "icon" }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
      ...
      aria-hidden="true"
      dangerouslySetInnerHTML={{ __html: icons[name] || icons.target }}
    />
  );
}
